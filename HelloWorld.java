 ...
 *
 * com.pfs.samples - Create the folder com->pfs->samples under the project src folder
 *
 ...
 * Class Name - Pascal Case - First letter of all the words must be capitalized
 * Method Name - Camel Case - First letter is lower case
 *                             and the first letter of all other words must be capitalized
 *
 * Wrapping line - Try not to type more than your screen width.
 *
 */
public class HelloWorld {
    // access modifier   return type      method name    (parameter(s))
    public static void main(String[] args) {
        System.out.println("Hello World!"); // Standard Console Output
